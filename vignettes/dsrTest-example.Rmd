...
all_methods <- mapply(dsrTest::dsrTest,
...
names(all_methods) <- c("gamma [wmtype=max]","gamma [midp]", 
                        "gamma [wmtype=tcz]", "gamma [wmtype=mean]", 
                        "gamma [wmtype=minmaxavg]",
                        "asymptotic [trans=none]", "asymptotic [trans=log]",
                        "dobson [exact ci]","dobson [midp=TRUE]",
                         "beta", "bootstrap")
